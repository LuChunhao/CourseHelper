...
public interface ISchedule {
    ...
    interface OnItemClickListener {
         ...
         */
        void onItemClick(View v, List<Schedule> scheduleList, int day,int start);
    }
    ...
    interface OnItemLongClickListener {
         ...
         * @param start 节次，从1开始
         */
        void onLongClick(View v, List<Schedule> scheduleList, int day,int start, Schedule subject);
    }
